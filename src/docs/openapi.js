  ...
  paths: {
    "/auth/register": {
      post: {
        ...
        responses: {
          201: apiResponse("Account created", { $ref: "#/components/schemas/AuthSession" }),
          ...errorResponses
        }
      }
    },
    "/auth/login": {
      post: {
        ...
        responses: {
          200: apiResponse("Login successful", { $ref: "#/components/schemas/AuthSession" }),
          ...errorResponses
        }
      }
    },
    "/auth/me": {
      get: {
        ...
        responses: {
          200: apiResponse("Current user", { $ref: "#/components/schemas/User" }),
          ...errorResponses
        }
      }
    },
    ...
    "/users/dashboard": {
      get: {
        ...
        security: bearerSecurity,
        responses: { 200: apiResponse("Dashboard snapshot"), ...errorResponses }
      }
    },
    "/users/onboarding": {
      patch: {
        ...
        responses: { 200: apiResponse("Onboarding updated"), ...errorResponses }
      }
    },
    "/users/profile": {
      patch: {
    ...
    "/users/wearables": {
      post: {
        ...
        responses: { 200: apiResponse("Wearable connection updated"), ...errorResponses }
      }
    },
    "/users/referrals": {
      get: {
    ...
    "/users/notifications/{id}/read": {
      patch: {
        ...
        security: bearerSecurity,
        parameters: [idParam],
        responses: { 200: apiResponse("Notification updated"), ...errorResponses }
      }
    },
    "/users/support-tickets": {
      post: {
        ...
        responses: { 201: apiResponse("Support ticket created"), ...errorResponses }
      }
    },
    "/plans/generate": {
      post: {
        ...
        responses: { 201: apiResponse("Weekly plan generated"), ...errorResponses }
      }
    },
    "/plans/regenerate": {
      post: {
    ...
    "/plans/current": {
      get: {
        ...
        security: bearerSecurity,
        responses: { 200: apiResponse("Current weekly plan"), ...errorResponses }
      }
    },
    "/plans/workouts/log": {
      post: {
    ...
    "/plans/workouts/logs/{id}": {
      patch: {
        ...
        responses: { 200: apiResponse("Workout log updated"), ...errorResponses }
      }
    },
    ...
    "/plans/progress": {
      post: {
        ...
        responses: { 201: apiResponse("Progress entry added"), ...errorResponses }
      }
    },
    "/plans/insights": {
      get: {
        ...
        security: bearerSecurity,
        responses: { 200: apiResponse("Progress and insights"), ...errorResponses }
      }
    },
    "/plans/ai-chat": {
      post: {
          ...
          content: {
            "application/json": {
              schema: {
                type: "object",
                required: ["message"],
                properties: { message: { type: "string", example: "What should I focus on today?" } }
              }
            }
          }
        },
    ...
    "/nutrition/generate-meal-plan": {
      post: {
        ...
        security: bearerSecurity,
        responses: { 200: apiResponse("Meal plan generated"), ...errorResponses }
      }
    },
    "/nutrition/recipes": {
      get: {
    ...
    "/nutrition/meal-swap": {
      post: {
        ...
        responses: { 200: apiResponse("Meal swap generated"), ...errorResponses }
      }
    },
    "/matches": {
      get: {
    ...
    "/matches/auto-adjust-plan": {
      post: {
        ...
        security: bearerSecurity,
        responses: { 200: apiResponse("Plans auto-adjusted around matches"), ...errorResponses }
      }
    },
    "/matches/{id}/hub": {
      get: {
    ...
    "/matches/{id}/performance": {
      post: {
        ...
        responses: { 200: apiResponse("Performance log saved"), ...errorResponses }
      }
    },
    "/community/media": {
      post: {
    ...
    "/integrations/checkout": {
      post: {
        ...
        responses: { 200: apiResponse("Checkout session created"), ...errorResponses }
      }
    },
    "/integrations/referral-link": {
      get: {
        ...
        security: bearerSecurity,
        responses: { 200: apiResponse("Referral link created"), ...errorResponses }
      }
    },
    "/admin/dashboard": {
      get: {
